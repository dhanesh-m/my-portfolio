      ...
      <div className="max-w-2xl">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded border border-white/10 text-gray-300 hover:border-[#00D9A5]/30 hover:text-[#00D9A5] transition-colors text-sm"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded border border-white/10 text-gray-300 hover:border-[#25D366]/50 hover:text-[#25D366] transition-colors text-sm"
          >
        ...
        <motion.footer
          ...
          className="mt-16 pt-8 border-t border-white/5 text-gray-500 text-xs"
        >
