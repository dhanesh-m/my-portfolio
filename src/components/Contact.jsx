    ...
    <section id="contact" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#00D9A5] text-[#0A0E14] font-semibold hover:bg-[#00E5B3] transition-colors hover:shadow-lg hover:shadow-[#00D9A5]/25"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/20 text-white font-medium hover:border-[#25D366]/50 hover:bg-[#25D366]/5 transition-all duration-300"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/20 text-white font-medium hover:border-[#00D9A5]/50 hover:bg-white/5 transition-all duration-300"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <motion.footer
          ...
          className="mt-24 pt-12 border-t border-white/5 text-center text-gray-500 text-sm"
        >
